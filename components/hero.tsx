        ...
        <div>
            ...
            <div className="relative flex flex-col justify-center items-center h-auto mx-[5vw] mb-0 mt-[2vw] py-[7vw] text-white bg-gradient-to-br from-[#f45455] via-[#f45455] to-[#e63946] border-0 rounded-[2vw] px-[3vw] overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 opacity-10">
                    ...
                    <div className="absolute bottom-[15%] right-[10%] w-[25vw] h-[25vw] bg-yellow-300 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-[2.5vw] font-light opacity-95 mb-[4vw] max-w-[60vw] mx-auto" style={{ fontFamily: '"Bahnschrift", Arial, sans-serif' }}>
