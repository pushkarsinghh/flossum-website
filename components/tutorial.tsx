    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 animate-fade-in-up">
                <div>
                    <h1
                        className="text-3xl sm:text-4xl font-bold md:text-5xl leading-tight text-white"
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            >
                                ...
                                {copiedCode === 'js' ? (
                                    ...
                                    <svg className="w-5 h-5 text-gray-400 group-hover/btn:text-gray-300 relative z-10 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="relative bg-gradient-to-br from-[#1e1e2e] to-[#151521] p-6 rounded-2xl border border-gray-800 group-hover:border-[#f45455]/50 transition-all duration-500 shadow-2xl">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-500 text-sm mt-0.5">Direct command line</p>
                            </div>
                            <button
            ...
            <div className="mt-16 animate-fade-in" style={{ animationDelay: '300ms' }}>
                <h3
                    className="text-2xl sm:text-3xl font-semibold mb-6 text-white flex items-center gap-3"
                    style={{ fontFamily: ubuntu.style.fontFamily }}
                >
            ...
            <section className="flex flex-col mt-16">
                <h2
                    className="text-2xl sm:text-3xl md:text-4xl mb-8 text-white font-bold flex items-center gap-3"
                    style={{ fontFamily: ubuntu.style.fontFamily }}
                >
                    <span className="text-3xl">✨</span>
                    Available Effects
                        ...
                        >
                            ...
                            <div className="relative">
                                <div className="flex items-start gap-3 mb-3">
                                    <span className="text-3xl transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">{emoji}</span>
                                    <div className="flex-1">
                                        <h3 className="text-white font-semibold text-lg mb-2 group-hover:text-[#ff8b8b] transition-colors duration-300" style={{ fontFamily: ubuntu.style.fontFamily }}>
                                            {title}
                                        </h3>
